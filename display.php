...
<?php $xml = simplexml_load_file("pages/menu/content.xml"); ?>
		...
		<div id="myModal1" class="modal fade in" style="display:none" aria-hidden="false">
								...
								<button aria-label="Close" data-dismiss="modal" class="close" type="button" style="color: #fff; position: absolute; margin: 0px -16px; opacity: 1;"><span aria-hidden="true">×</span></button>
                            ...
                            <div class="strock">
								...
								<?php if ($item['price']!='0.00') { ?>
                                    <div class="block">
										...
										<?php echo $item['price']; ?>  <img class="show_popup" dir="<?php echo $item['id']; ?>" b="<?php echo $item['title']; ?>" src="img/add.png" alt="" >
