...
class FileUpload {
	...
	function uploadFile() {
		...
		/*if ($ext=="jpg" || $ext=="jpeg" ) {
			imagejpeg($tmp,$this->pathupload."/".$file_name,100);
		} else if($ext=="png") {
			imagepng($tmp,$this->pathupload."/".$file_name,5);
		} else if ($ext=="gif") {
			imagegif($tmp,$this->pathupload."/".$file_name);
		}*/
