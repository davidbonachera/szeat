...
if ($_POST) {
	...
	if (isset($_GET['reorder'])) {
		...
		header("Location: menu.php?restaurant={$restaurant}&id={$order['restaurant_id']}");
		exit;
	} else {
		$orderID = $db->escape($_GET['order']);
	}
        	...
        	<div class="span12">
            	<div class="block-page">
                    <div class="order-summery table-sorter">
                        ...
                        <table width="368">
                            <thead>
                                <tr>
                                    ...
                                    <th align="left"width="15%">Order number</th>
                                    <th align="left"width="15%">Restaurant</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <?php } ?>
                        <a href="#" class="yellow-button print" onclick="window.print(); return false;">Print</a>
                    </div>
