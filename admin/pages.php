...
if (isset($_GET['id']) && checkFeild($_GET['id'])) {
	...
	if (isset($_GET['delete'])) {
		if($db->query("DELETE FROM pages WHERE id='$id' LIMIT 1")) {
			$_SESSION['msg'] = "Page successfully deleted.";
			$_SESSION['error'] = false;
			header("Location: pages.php");
			exit();
		} else {
			$_SESSION['msg'] = "Page can't be deleted.";
			$_SESSION['error'] = true;
			header("Location: pages.php");
			exit();
		}
                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-list-alt"></i><span class="break"></span>Pages</h2>
                                <div class="box-icon">
                                    <a href="pages-add.php" class="btn-link noUnderline"><i class="fa-icon-plus"> Add New Page</i></a>
                                </div>
                            </div>
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                  ...
                                  <tbody>
                                    <?php $query = $db->query("SELECT * FROM pages ORDER BY id"); ?>
                                    <?php if ($db->affected_rows > 0) { ?>
										<?php while($r=$db->fetch_array($query)) { ?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-info" href="pages-edit.php?id=<?php echo $r['id']; ?>" title="Edit">
