                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            ...
                            <form class="form-horizontal" method="post">  
                                <div id="tabs">
                                    <ul>
                                        <li><a href="#tabs-2">中國</a></li>
                                        <li><a href="#tabs-1">English</a></li>
                                    </ul>
                                    <div id="tabs-1">
                                        <p> <div class="box-content" style="background:none;border: none;">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="date">收到</label>
                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo date("H:i d-m-y", strtotime($query['date'])); ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    <?php
                                                    if (getData('restaurants', 'name_cn', $query['restaurant_id']) != '') {
                                                        $res_id = getData('restaurants', 'name_cn', $query['restaurant_id']);
                                                        ?><label class="control-label" for="restaurant_id">名字</label>
                                                        <?php
                                                    } else {
                                                        $res_id = getData('restaurants', 'name', $query['restaurant_id']);
                                                        ?>
                                                        <label class="control-label" for="restaurant_id">名字(EN)</label>
                                                        <?php
                                                    }
                                                    ?>
                                                ...
                                                <div class="control-group">
                                                    <?php
                                                    if (getData('restaurants', 'name_cn', $query['restaurant_id']) != '') {
                                                        $res_id = getData('restaurants', 'address_cn', $query['restaurant_id']);
                                                        ?><label class="control-label" for="restaurant_id">地址</label>
                                                        <?php
                                                    } else {
                                                        $res_id = getData('restaurants', 'address', $query['restaurant_id']);
                                                        ?>
                                                        <label class="control-label" for="restaurant_id">地址(EN)</label>
                                                        <?php
                                                    }
                                                    ?>

                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo $res_id; ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="restaurant_id">電話</label>
                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo getData('restaurants', 'phone', $query['restaurant_id']); ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <table cellpadding="5" style="margin-left:105px">
                                                    ...
                                                    <?php if ($db->affected_rows > 0) { ?>
                                                        <?php while ($r2 = $db->fetch_array($query2)) { ?>
                                                            ...
                                                            <!-- ------------------------------layers code start ------------------------------------------------------------------------------	-->
                                                            <?php
                                                            $layers_ofitems = $db->query("SELECT * FROM order_item_layers WHERE order_item_id={$r2['id']} GROUP BY layer_id ");

                                                            if ($db->affected_rows > 0) {
                                                                ?>

                                                                <?php
                                                                while ($lay_ersofitem = $db->fetch_array($layers_ofitems)) {
                                                                    ...
                                                                    <tr><td colspan="6">
                                                                            <div class="main_it_cla" style="">
                                                                                ...
                                                                                <?php
                                                                                $attrib = $db->query("SELECT * FROM order_item_layers WHERE order_item_id={$r2['id']} AND layer_id={$lay_ersofitem['layer_id']}");
                                                                                if ($db->affected_rows > 0) {
                                                                                    ?>
                                                ...
                                                <div class="control-group">
                                                    <?php
                                                    if (getData('restaurants', 'name_cn', $query['restaurant_id']) != '') {
                                                        $res_id = getData('areas', 'title_cn', $userInfo['area_id']);
                                                        ?><label class="control-label" for="user_id">區域</label>
                                                        <?php
                                                    } else {
                                                        $res_id = getData('areas', 'title_cn', $userInfo['area_id']);
                                                        ?>
                                                        <label class="control-label" for="user_id">區域(EN)</label>
                                                        <?php
                                                    }
                                                    ?>
                                                ...
                                                <div class="control-group">
                                                    <?php
                                                    if (getData('restaurants', 'name_cn', $query['restaurant_id']) != '') {
                                                        $res_id = getData('buildings', 'title_cn', $userInfo['building_id']);
                                                        ?><label class="control-label" for="user_id">建造</label>
                                                        <?php
                                                    } else {
                                                        $res_id = getData('buildings', 'title', $userInfo['building_id']);
                                                        ?>
                                                        <label class="control-label" for="user_id">建造(EN)</label>
                                                        <?php
                                                    }
                                                    ?>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="user_id">塊/公寓＃</label>
                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo $userInfo['apartment']; ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="user_id">電話</label>
                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo $userInfo['phone']; ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="user_id">名字</label>
                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo $userInfo['name']; ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="user_id">電子郵件</label>
                                                    <div class="controls">
                                                        <span class="input-xlarge uneditable-input"><?php echo $userInfo['email']; ?></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div id="tabs-2">
                                        <p> <div class="box-content" style="background:none;border: none;">
                                            ...
                                            <fieldset>
                                                ...
                                                <h1>&nbsp;</h1>
                                                <div class="control-group">
                                                    <label class="control-label">送到餐廳</label>
                                                    <div class="controls">
                                                        <label class="radio">
                                                            <input type="radio" name="sent" id="sent1" value="1" <?php echo $query['sent'] == 1 ? 'checked' : NULL; ?>>
                                                            是的
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label">付費</label>
                                                    <div class="controls">
                                                        <label class="radio">
                                                            <input type="radio" name="paid" id="paid1" value="1" <?php echo $query['paid'] == 1 ? 'checked' : NULL; ?>>
                                                            是的
                                                ...
                                                -->
                                                <div class="form-actions">
                                                    <button id="submit" name="submit" type="submit" class="btn btn-primary">保存更改</button>
                                                    <button class="btn" id="cancelButton">取消</button>
                                                </div>
                                            </fieldset>
