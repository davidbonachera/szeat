...
<?php is_session(); ?>
<?php $id = addslashes($_GET['id']); $mmid = addslashes($_GET['m_id']);//print_r( $id); print_r( $_GET['m_id']); die; ?>
<?php 
unset($_SESSION["menu"]);
                                     ...
                                     <!--   <div class="control-group">
                                      ...
                                      <div class="control-group">
                                        ...
                                        <div class="controls">
										 ...
										 <div class="control-group">
                                        <label class="control-label" for="maximum_selected"></label>
                                        <div class="controls">
                                          <input type="hidden" class="input-xlarge focused" id="maximum_selected" name="maximum_selected" type="text" value="9">
                                        </div>
                                      </div>
