...
<?php
if (!checkFeild($id)) {
	$_SESSION['msg'] 	= "Cuisine Not Found.";
...
if ($_POST) {
	if (checkFeild($_POST["title"])) {
		...
		$db->query_update("cuisines", $data, "id='$id'");
		if($db->affected_rows > 0){
			$_SESSION['msg'] = "Cuisine successfully updated.";
			$_SESSION['error'] = false;
			header("Location: cuisines-edit.php?id=$id");
			exit();
		} else {
			$_SESSION['msg'] = "<strong>Oops!</strong> Cuisine wasn't updated.";
			$_SESSION['error'] = true;
			header("Location: cuisines-edit.php?id=$id");
			exit();
		}
...
$query = $db->query_first("SELECT * FROM cuisines WHERE id='$id'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-edit"></i><span class="break"></span>Edit Cuisine</h2>
                            </div>
                                ...
                                <form class="form-horizontal" method="post">
                                    <fieldset>
                                      <div class="control-group">
                                        <label class="control-label" for="title">* English Cuisine Type</label>
                                        <div class="controls">
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="title">Chinese Cuisine Type</label>
                                        <div class="controls">
