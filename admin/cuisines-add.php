...
if ($_POST) {
	if (checkFeild($_POST["title"])) {
		...
		$pid = $db->query_insert("cuisines", $data);
		
		if($db->affected_rows > 0){
			$_SESSION['msg'] = "Cuisine successfully created.";
			$_SESSION['error'] = false;
			header("Location: cuisines.php");
			exit();
		} else {
			$_SESSION['msg'] = "<strong>Oops!</strong> Cuisine can't be created.";
			$_SESSION['error'] = true;
		}
	} else {
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-plus"></i><span class="break"></span>Add New Cuisine</h2>
                            </div>
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" method="post">
                                    <fieldset>
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="title_cn">Chinese Cuisine Type</label>
                                        <div class="controls">
