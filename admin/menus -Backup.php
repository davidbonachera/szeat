eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee<?php require_once("../class/config.inc.php"); ?>
                                    ...
                                    <?php if ($db->affected_rows > 0) { ?>
                                        <?php while($r=$db->fetch_array($query)) { ?>
                                            <tr>
												...
												<td class="center">
												<a class="btn btn-info" href="menu_layers_show.php?id=<?php echo $id; ?>&m_id=<?php echo $r["id"]; ?>" title="View">
												</td>			
