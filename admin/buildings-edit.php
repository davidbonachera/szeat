...
<?php
if (!checkFeild($id)) {
	$_SESSION['msg'] 	= "Building Not Found.";
...
if ($_POST) {
    ...
    $data["status_cn"]     = $_POST["status_cn"];
		...
		$db->query_update("buildings", $data, "id='$id'");
		if($db->affected_rows > 0){
			$_SESSION['msg'] = "Building successfully updated.";
			$_SESSION['error'] = false;
			header("Location: buildings-edit.php?id=$id");
			exit();
		} else {
			$_SESSION['msg'] = "<strong>Oops!</strong> Building wasn't updated.";
			$_SESSION['error'] = true;
			header("Location: buildings-edit.php?id=$id");
			exit();
		}
...
$query = $db->query_first("SELECT * FROM buildings WHERE id='$id'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-edit"></i><span class="break"></span>Edit Building</h2>
                            </div>
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" method="post">
                                    <fieldset>
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="title">* English Building Name</label>
                                        <div class="controls">
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="title_cn">Chinese Building Name</label>
                                        <div class="controls">
