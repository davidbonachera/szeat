...
if (isset($_POST) && !empty($_POST)) {
    ...
    if (checkFeild(checkFeild($_POST['name']) && checkFeild($_POST['maximum_selected']))) {
      ...
      //  echo "<pre>";print_r($data);die;
        ...
        if ($db->query_update("menu_item_layers", $data, "id='$layerid'")) {
            $_SESSION['error'] = false;
            $_SESSION['msg'] = "Menu Item successfully edited";
            header("Location: menu_layers_show.php?id=$id&m_id=$mid");
            exit();
        } else {
            $_SESSION['error'] = true;
            $_SESSION['item'] = "item";
...
$query = $db->query_first("SELECT * FROM menu_item_layers WHERE id='$layerid'");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                                ...
                                <form class="form-horizontal" method="post">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="input" class="input-xlarge focused" value="<?php echo $query['maximum_selected']; ?>" id="maximum_selected" name="maximum_selected" type="text" required="required">
                                            </div>
                                        </div>
