        	...
        	<div class="row product-row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 pull-right type-food">
                            <h3>Delivery Time</h3>
                ...
                <div class="col-md-3 restaurant-view">
                    <div class="view-menu"><a class="yellow-button" href="index.php?page=menu&restaurant=<?php echo urlText($res['name']); ?>&id=<?php echo $res['restaurant_id']; ?>">View menu</a></div>
