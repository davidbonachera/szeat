...
<!--                             <a href="index.php?<?php echo 'page='.$page.'&';?>lang=en"><img src="img/uk-flag.png" style="max-height:44px;" /></a>
                            ...
                            <a class="cursor" id="engclick"><img src="img/uk-flag.png" style="max-height:44px;" /></a>
                            <a class="cursor" id="chingclick"><img src="img/china-flag.png" style="max-height:44px;" /></a>  
                        </div>              
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
